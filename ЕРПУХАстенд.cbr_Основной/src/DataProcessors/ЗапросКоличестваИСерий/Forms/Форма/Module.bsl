...
Процедура cbr_ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Объект.Регистратор) = Тип("ДокументСсылка.ЗаказКлиента") Тогда 
		cbr_РаботаСФормами.ДобавитьРеквизитФормы(ЭтаФорма, "cbr_ПоказыватьСерииБезУчетаСпецТребований", Новый ОписаниеТипов("Булево"));
		cbr_РаботаСФормами.ДобавитьРеквизитФормы(ЭтаФорма, "cbr_НеБолееДатыПроизводства", ОбщегоНазначения.ОписаниеТипаЧисло(3, 0));
		cbr_РаботаСФормами.ДобавитьРеквизитФормы(ЭтаФорма, "cbr_ДопустимыйОстатокГСХНеМенееПроцент", ОбщегоНазначения.ОписаниеТипаЧисло(3, 0));
		cbr_РаботаСФормами.ДобавитьРеквизитФормы(ЭтаФорма, "cbr_ДопустимыйОстатокГСХНеМенееМес", ОбщегоНазначения.ОписаниеТипаЧисло(3, 0));
		ЭтаФорма.cbr_ПоказыватьСерииБезУчетаСпецТребований;
