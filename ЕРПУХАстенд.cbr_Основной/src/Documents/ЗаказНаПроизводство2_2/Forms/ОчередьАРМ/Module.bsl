...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если Настройки.Получить("ДопПанельСвернута") = Истина Тогда
		НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ДопПанель");
	КонецЕсли;
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборПодразделение, ОтборОтветственный");
...
Процедура СформироватьЭтапыПроизводства(Команда)
	...
	ИначеЕсли КоличествоЗаказовПоВариантамРаботы[1] > 0 Тогда
		...
		ОткрытьФорму("Обработка.ФормированиеЭтаповПроизводства.Форма.Форма", Новый Структура("СтруктураОтборов", СтруктураОтборов), ЭтотОбъект);
...
Процедура ПометитьНаУдалениеЭтапыПроизводства(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПометитьНаУдалениеЭтапыПроизводстваЗавершение", ЭтотОбъект, ВыбранныеЗаказы);
...
Процедура СформироватьПеремещенияПоЗаказуНаПроизводство(Команда)
	...
	ОткрытьФорму("Обработка.ФормированиеПеремещенийПоЗаказамНаПроизводство.Форма", Новый Структура("СтруктураОтборов", СтруктураОтборов), ЭтотОбъект, УникальныйИдентификатор);
...
Процедура ПеренестиЖелаемыеДатыОбеспечения(Команда)
	...
	ОткрытьФорму("Обработка.ПереносЖелаемойДатыОбеспеченияЭтаповПроизводства.Форма",
		ПараметрыФормы, ЭтотОбъект, ВыбранныеЗаказы[0]);
...
Процедура ОтборСрокВыполненияПриИзменении(Элемент)
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборСрокВыполнения");
...
Процедура СтруктураДополнительныхОтборовОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "СтруктураДополнительныхОтборов");
...
Процедура ОтборПоСостояниюПриИзменении(Элемент)
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборПоСостоянию");
...
Процедура УстановитьОтборПриоритет()
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборПриоритет");
...
Процедура УстановитьОтборПодразделение()
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборПодразделение");
...
Процедура УстановитьОтборОтветственный()
	...
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ОтборОтветственный");
...
Процедура ОткрытьДиспетчированиеЭтапов(Распоряжение, ДополнительныеОтборы = Неопределено)
	...
	ОткрытьФорму("Документ.ЭтапПроизводства2_2.Форма.Диспетчирование",
		Новый Структура("СтруктураОтборов", Отборы), ЭтотОбъект);
...
Процедура ОткрытьФормирующиесяЗаказы()
	...
	СтруктураОтборов = ЗначенияОсновныхОтборов(ЭтотОбъект, Ложь);
...
Процедура ПоказыватьДеталиНажатие(Элемент)
	...
	ОбновитьЭтапыПроизводстваПриАктивизацииСтроки();
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ПоказыватьДетали");
