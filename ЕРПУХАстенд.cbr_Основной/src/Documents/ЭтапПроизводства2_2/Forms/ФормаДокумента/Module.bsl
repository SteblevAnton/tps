...
Функция cbr_ПолучитьДанныеТЗНаСервере(АдресТЗДанных)
	...
	МассивЭтапов = ПолучитьИзВременногоХранилища(АдресТЗДанных);
	...
	Пока Выборка.Следующий() Цикл
		...
		//Отбор.Вставить("Обособленно",Выборка.Обособленно);
		//Отбор.Вставить("Назначение",Выборка.Назначение);
		//Отбор.Вставить("НазначениеОбеспечения",Выборка.НазначениеОбеспечения);
