...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимОткрытия = "Полный" Или Параметры.РежимОткрытия = "ТолькоСпособ" Тогда
		...
		Если ЗначениеЗаполнено(СпособУнаследованный) Тогда
			...
			Обработки.ОбеспечениеПотребностейНоваяСхема.ЗаполнитьРеквизитыСпособаОбеспечения(ПараметрыЦиклаПоставки, НачалоПериода, Истина);
...
Функция ПолучитьСтатистикуПотребленияВФоне()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.ОбеспечениеПотребностейНоваяСхема.СтатистикаПотребления",
