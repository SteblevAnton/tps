...
Процедура cbr_ЗаполнитьРасходы(ДокументОснование, НесколькоОрганизаций) Экспорт
    ...
    Подразделение = Справочники.cbr_ПредопределенныеЗначенияКонстант.ТПСОтделЛогистикиИВЭД;
    СтавкаНДС = СтавкаНДС();
    ...
    Для Каждого Строка Из ТЗ Цикл
        ...
        Если ТипЗнч(Строка.Распоряжение) = Тип("ДокументСсылка.ЗаказКлиента") Тогда
            Если Строка.Организация = Справочники.Организации.НайтиПоРеквизиту("ИНН", "5042063026") Тогда
                НоваяСтрока.СтатьяРасходов = Справочники.cbr_ПредопределенныеЗначенияКонстант.ТранспортныеУслугиДоставкаПокупателюТранспортнойКомпании26;
            Иначе
                НоваяСтрока.СтатьяРасходов = Справочники.cbr_ПредопределенныеЗначенияКонстант.ТранспортныеУслугиДоставкаПокупателюТранспортнойКомпании44;
            КонецЕсли;
        ИначеЕсли ТипЗнч(Строка.Распоряжение) = Тип("ДокументСсылка.ЗаказПоставщику") Тогда
            НоваяСтрока.СтатьяРасходов = Справочники.cbr_ПредопределенныеЗначенияКонстант.ТранспортныеУслугиДоставкаПокупателюТранспортнойКомпании;
        КонецЕсли;
