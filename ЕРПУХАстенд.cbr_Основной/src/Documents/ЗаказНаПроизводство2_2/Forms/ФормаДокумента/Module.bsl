...
Процедура ПодготовитьФорму()
	...
	Документы.СпециальныеТребования.ВывестиТаблицуСпецТребований(ЭтаФорма, Элементы.Содержание, УсловияВидимостиСпецтребований, ЭтаФорма.Объект.ДокументОснование);
	
	// НАЧАЛО Алейников М.Н. 24.03.2025 Б121 
	ИмяКомандыПересчитатьКоличествоУпаковок = "П3_ПересчитатьКоличествоУпаковок";
	Команда = ФормыУХ.СоздатьКоманду(ЭтаФорма, ИмяКомандыПересчитатьКоличествоУпаковок, "", ИмяКомандыПересчитатьКоличествоУпаковок);
