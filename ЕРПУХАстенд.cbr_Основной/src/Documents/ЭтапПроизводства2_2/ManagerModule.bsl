...
&ИзменениеИКонтроль("СтатусыДокументаИзменяемыеИзСписка")
Функция cbr_СтатусыДокументаИзменяемыеИзСписка() Экспорт
	...
	#Вставка
	//++ Мохов ПРЗ.18
	ОбщегоНазначенияУТ.ДобавитьСтрокуВТаблицуСтатусовИзменяемыхИзСписка(Таблица, Перечисления.СтатусыЭтаповПроизводства2_2.cbr_НаКонтроле);		
	//-- Мохов ПРЗ.18
	#КонецВставки	
	Возврат Таблица;
