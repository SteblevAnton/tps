...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка, ДополнительныеПараметры) Экспорт
	...
	//-- Тусеев Н.Ю. 27.01.2026 ПРД7 
		...
		cbr_РаботаСФормами.ДобавитьРеквизитФормы(форма, "СтрокаИзСоглашенияСКлиентом", "", "Объект.Товары", НСтр(
			"ru='СтрокаИзСоглашенияСКлиентом'"), Истина);

		cbr_РаботаСФормами.ДобавитьПолеФормы(Форма, "ТоварыСтрокаИзСоглашенияСКлиентом",
			"Объект.Товары.СтрокаИзСоглашенияСКлиентом", НСтр("ru='Это строка из соглашения с клиентом'"),
