...
Процедура cbr_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	СпецификацияДействует = Перечисления.СтатусыСпецификаций.Действует;
	...
	Для каждого СтрокаТовары Из Товары Цикл
		Если НЕ ЗначениеЗаполнено(СтрокаТовары.Спецификация)  
			И НЕ СтрокаТовары.cbr_ЭтоПФ Тогда
