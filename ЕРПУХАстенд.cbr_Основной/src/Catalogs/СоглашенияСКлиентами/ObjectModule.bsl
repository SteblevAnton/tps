...
//++AlopinAs 170326 ПРД20
		|	ВТТЧИстор.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
//--AlopinAs 170326 ПРД20
...
//++AlopinAs 170326 ПРД20
		|			И ВТТЧИстор.ЕдиницаИзмерения = ВТТЧАктуал.ЕдиницаИзмерения
//--AlopinAs 170326 ПРД20
...
//++AlopinAs 170326 ПРД20
		|			И (ВТИсторИзмененнаяНоменклатура.ЕдиницаИзмерения = cbr_ОперацияСоглашенияСписокНоменклатура.ЕдиницаИзмерения)
//++AlopinAs 170326 ПРД20
...
//++AlopinAs 170326 ПРД20
		|		И ВТТЧ.ЕдиницаИзмерения = ВТГруппировка.ЕдиницаИзмерения
//--AlopinAs 170326 ПРД20
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
...
//++AlopinAs 170326 ПРД20
		|		И ВТТЧ.ЕдиницаИзмерения = ВТТЧ1.Характеристика
//--AlopinAs 170326 ПРД20
...
//			ВыборкаДубли.Номенклатура, ВыборкаДубли.Характеристика, ВыборкаДубли.НомерСтроки));		
		ОбщегоНазначения.СообщитьПользователю(СтрШаблон(НСтр("ru = 'Обнаружны дубли по номенклатуре ""%1"", характеристике ""%2"", единице измерения ""%3 "" на строке ""%4""'"),
			ВыборкаДубли.Номенклатура, ВыборкаДубли.Характеристика, ВыборкаДубли.ЕдиницаИзмерения, ВыборкаДубли.НомерСтроки));
		//--AlopinAs 170326 ПРД20
...
//			ВыборкаВхождениеДиапазонаДат.Номенклатура, ВыборкаВхождениеДиапазонаДат.Характеристика));
		ОбщегоНазначения.СообщитьПользователю(СтрШаблон(НСтр("ru = 'Обнаружны пересечения промежутков дат по номенклатуре ""%1"", характеристике ""%2"", единице измереиния ""%3""'"),
			ВыборкаВхождениеДиапазонаДат.Номенклатура, ВыборкаВхождениеДиапазонаДат.Характеристика, ВыборкаВхождениеДиапазонаДат.ЕдиницаИзмерения));
		//++AlopinAs 170326 ПРД20
	КонецЦикла;
