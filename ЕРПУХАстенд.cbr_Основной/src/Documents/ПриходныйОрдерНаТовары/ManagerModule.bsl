...
Функция cbr_СоздатьПриходныйОрдерИзДвиженияПродукцииИМатериалов(ДвижениеПродукции, Распоряжение, Помещение) Экспорт
	...
	ПриходныйОрдер.ДополнительныеСвойства.Вставить("cbr_ЗаполнитьКоличествоПоРаспоряжению");
	...
	Иначе
		ТекстСообщения = НСтр("ru = 'Ошибка проведения документа ""Приходный ордер на товары"" по распоряжению %1'");
